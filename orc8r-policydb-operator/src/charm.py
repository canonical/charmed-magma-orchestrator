...
class MagmaOrc8rPolicydbCharm(CharmBase):
    ...
    def __init__(self, *args):
        ...
        self._service_patcher = KubernetesServicePatch(
            charm=self,
            ports=[
                ServicePort(name="grpc", port=9180, targetPort=9085),
                ServicePort(name="http", port=8080, targetPort=10085),
                ServicePort(name="grpc-internal", port=9190, targetPort=9185),
            ],
            additional_labels={
