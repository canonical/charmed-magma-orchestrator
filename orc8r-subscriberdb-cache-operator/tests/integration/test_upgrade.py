...
APPLICATION_NAME = SERVICE_NAME = "orc8r-subscriberdb-cache"
CHARM_NAME = "magma-orc8r-subscriberdb-cache"
CHARM_RESOURCES = {
...
class TestOrc8rSubscriberdbcacheUpgrade:
    ...
    async def test_workload_services_match_charm_config(self, ops_test, setup, build_and_refresh):
        expected_ports = [
            {"name": "grpc", "port": 9180, "protocol": "TCP", "targetPort": 9089},
            {"name": "http", "port": 8080, "protocol": "TCP", "targetPort": 10087},
        ]
