...
class MagmaOrc8rDirectorydCharm(CharmBase):
    ...
    def __init__(self, *args):
        ...
        super().__init__(*args)
        self._container_name = self._service_name = "magma-orc8r-directoryd"
        ...
        self._service_patcher = KubernetesServicePatch(
            self, [("grpc", 9180, 9106)], service_name="orc8r-directoryd"
        )

    def _on_magma_orc8r_directoryd_pebble_ready(self, event):
        if not self._check_db_relation_has_been_established():
            ...
            event.defer()
            return
        self._configure_magma_orc8r_directoryd()
    ...
    def _configure_magma_orc8r_directoryd(self):
