...
Federation Gateway s6a proxy service translates
calls from GRPC to S6a protocol between AGW and HSS.
"""
...
class FegS6aProxyCharm(CharmBase):
    ...
    def __init__(self, *args):
        ...
        self.framework.observe(
            self.on.magma_feg_s6a_proxy_pebble_ready, self._on_magma_feg_s6a_proxy_pebble_ready
        )

    def _on_magma_feg_s6a_proxy_pebble_ready(self, event: PebbleReadyEvent) -> None:
