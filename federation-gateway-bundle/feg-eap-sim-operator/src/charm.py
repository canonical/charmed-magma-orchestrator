...
class FegEAPSIMCharm(CharmBase):
    ...
    def __init__(self, *args):
        ...
        self.framework.observe(
            self.on.magma_feg_eap_sim_pebble_ready, self._on_magma_feg_eap_sim_pebble_ready
        )

    def _on_magma_feg_eap_sim_pebble_ready(self, event: PebbleReadyEvent) -> None:
