...
Federation Gateway swx-proxy service translates GRPC
interface to SWx protocol between AGW and HSS.
"""
...
class FegSwxProxyCharm(CharmBase):
    ...
    def __init__(self, *args):
        ...
        self.framework.observe(
            self.on.magma_feg_swx_proxy_pebble_ready, self._on_magma_feg_swx_proxy_pebble_ready
        )

    def _on_magma_feg_swx_proxy_pebble_ready(self, event: PebbleReadyEvent) -> None:
