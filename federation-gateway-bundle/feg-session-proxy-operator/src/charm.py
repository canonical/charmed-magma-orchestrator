...
Federation Gateway session-proxy service translates calls
 from GRPC to gx/gy protocol between AGW and PCRF/OCS.
"""
...
class FegSessionProxyCharm(CharmBase):
    ...
    def _on_magma_feg_session_proxy_pebble_ready(self, event: PebbleReadyEvent) -> None:
